...
namespace IT008_AppHocAV.View.CustomMessageBox
{
    ...
    public partial class CTMessageBox : Window
    {
        
        private CTMessageBox()
        {
            InitializeComponent();
        }
        static CTMessageBox _messageBox;
